...
Este documento describe cómo reportar vulnerabilidades en **InforcapHouse** y qué prácticas de seguridad seguimos en el repositorio.
...
| Releases / tags         | Solo la última versión estable |
...
- Ejecuta auditorías de vulnerabilidades automáticas en CI (`bundle exec bundler-audit` y `brakeman`).
