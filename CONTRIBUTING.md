...
¡Gracias por tu interés en contribuir a **InforcapHouse**! Esta guía describe el flujo de trabajo, los estándares de código y el proceso de Pull Requests.
...
- Líneas de máximo 120 caracteres (default de RuboCop).
- Codificación UTF-8, finales de línea LF.

### Nombrado

- Sigue las convenciones idiomáticas de Ruby 3.2.2 (p. ej. `camelCase`/`snake_case`/`PascalCase` según corresponda).
...
- Ejecuta la suite completa antes de abrir el PR (`rails test`).
